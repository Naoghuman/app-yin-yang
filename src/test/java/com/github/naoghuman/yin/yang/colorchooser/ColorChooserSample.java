...
//    final ColorChooser colorChooser = new ColorChooser();  // to use the full web palette, just use the default constructor.
...
class ColorChooser extends VBox {
    ...
    /**
     * The color the user has selected or the default initial color (the first
     ...
     * http://docs.oracle.com/javafx/2.0/api/javafx/scene/doc-files/cssref.html#typecolor
     */
