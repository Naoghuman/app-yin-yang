 ...
 * @since  0.6.0
 */
public final class TaiChiRotation implements EventConfiguration, RegisterActions {
    
    private static final ObservableMap<Month, Double> MONTHLY_ROTATION_SPEED = FXCollections.observableHashMap();
    
    private static final Optional<TaiChiRotation> INSTANCE = Optional.of(new TaiChiRotation());
    
    public static final TaiChiRotation getDefault() {
        return INSTANCE.get();
    }
