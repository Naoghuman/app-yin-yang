 ...
 * @since  0.5.0
 */
public final class TaiChiColors implements 
        ...
        TaiChiConfiguration
{
    ...
    private static final Optional<TaiChiColors>         INSTANCE = Optional.of(new TaiChiColors());
    
    private static final String STYLE__BACKGROUND_COLOR_RADIUS = "-fx-background-color:%s;-fx-background-radius:5.0;"; // NOI18N
    
    public static final TaiChiColors getDefault() {
        return INSTANCE.get();
    }
    
    private TaiChiColors() {
