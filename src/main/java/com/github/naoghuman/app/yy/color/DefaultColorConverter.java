 ...
 * @since  0.1.0
 */
final class DefaultColorConverter implements ColorConverter {
    
    public DefaultColorConverter() {
    ...
    public String convertToBrighter(final String color, double opacity) {
        LoggerFacade.getDefault().debug(DefaultColorConverter.class, "DefaultColorConverter.convertToBrighter()"); // NOI18N
